"""
Django settings for gopasarapp project.
...
ALLOWED_HOSTS = ["gopasar.el.r.appspot.com", "localhost"]
...
WSGI_APPLICATION = 'gopasarapp.wsgi.application'
...
# IMPORTANT, need to add otherwise Token cannot be authenticated!
REST_FRAMEWORK = {
...
# --- development and deployment servers share same storage
...
# MEDIA_ROOT = "media/"
MEDIA_ROOT = 'https://storage.googleapis.com/{}/'.format(
